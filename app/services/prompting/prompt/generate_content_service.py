...
def build_output_instructions() -> str:
    ...
    return (
        ...
        "   - Berikan beberapa contoh SKENARIO NARATIF konkret tentang bentuk penyimpangan/"
        "ketidaksesuaian terhadap pasal/ayat yang teridentifikasi di atas (bukan menilai "
        "tindakan spesifik user, melainkan ilustrasi edukatif umum).\n"
        ...
        "ayat tersebut TIDAK terpenuhi/tidak sesuai (mis. jika ayat mensyaratkan susunan/jumlah/"
        "asal-unsur/prosedur tertentu, contohnya adalah kondisi di mana susunan/jumlah/asal-"
        "unsur/prosedur itu TIDAK dipenuhi). DILARANG mengarang kewajiban atau konsep yang "
        "sama sekali tidak disebut di teks pasal (mis. 'informasi rahasia', 'wewenang "
        ...
        "pembiayaan, atau tata kerja internal — mis. 'Komisi dibentuk dengan susunan yang "
        "tidak sesuai ayat (1)'), pejabat yang disebut eksplisit, ATAU warga sipil/pihak luar "
        "(jika ayat memang mengatur kewajiban/larangan bagi mereka). JANGAN memaksa "
        "penyimpangan itu ke warga sipil kalau ayat yang sebenarnya mengatur lembaga/institusi.\n"
        ...
        "   - Jika tidak ada dasar yang cukup relevan untuk membuat contoh penyimpangan yang "
        "valid dan berdasar, kembalikan list kosong ([]) — JANGAN memaksakan contoh yang "
        "tidak berdasar.\n\n"
...
class MaterialGeneratorService:
    ...
    async def generate_legal_material(self, data: MaterialRequest) -> MaterialResponse:
        ...
        system_prompt = (
            ...
            "DILARANG mengarang kewajiban/konsep yang tidak disebut di teks pasal. Pihak yang "
            "menyimpang menyesuaikan dengan siapa yang sebenarnya diatur pasal tersebut: bisa "
            "lembaga/institusi itu sendiri (jika pasal mengatur susunan, komposisi, pembiayaan, "
            "atau tata kerja internal), pejabat yang disebut eksplisit, atau warga sipil/pihak "
            "luar (jika pasal memang mengatur kewajiban/larangan bagi mereka).\n\n"
